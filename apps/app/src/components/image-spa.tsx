import { FileElementResponse, PayloadDto } from '@content-service/interfaces';
import { Icon } from '@rsuite/icons';
import { useState } from 'react';
import { Panel, SelectPicker, Uploader, InputNumber } from 'rsuite';
      ...
      <Panel bordered>
        ...
        {/*result && (
          <>
            ...
            <img
              className="result"
              src={process.env.REACT_APP_API_URL + result}
              alt="результат"
            />
          </>
        )*/}
